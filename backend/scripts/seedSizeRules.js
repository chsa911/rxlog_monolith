    ...
    async function seed() {
      try {
        ...
        const rules = [
         ...
         // Size 4 — keep ekg for <19 and give it priority so it wins when applicable
         {
           minB: 11.8,
           maxB: 11.9,
           maxBInc: true,
         ...
         // Size 5 — WIDENED + bands restored + inclusive upper bound + epsilon min
         {
           minB: 11.799,        // was 11.8 (epsilon so 11.8 passes w > minB)
           maxB: 12.3,
           maxBInc: true,       // include 12.3 so 12.3 can fall back here
           bands: [
         ...
         // Size 6 — keep narrow special case for 12.3–12.4 <19, high priority
         {
           minB: 12.3,
           maxB: 12.4,
           maxBInc: true,
          ...
          // ---- Size 8 ----
          {
            ...
            bands: [
              { condition: 'lt', value: 20, prefix: 'ek' },
               { condition: 'eq', values: [20], prefix: 'ek' },
              { condition: 'eq', values: [20.5, 21, 21.5], prefix: 'lk' },
              { condition: 'gt', value: 20, prefix: 'ok' },
            ],
          },
          // Size 9 (optional priority so it keeps 'lt 21' dominance)
          {
            minB: 13.0,
            maxB: 13.4,
            maxBInc: true,
          ...
          // Size 10 (start at 13.0 to cover 13.1–13.3)
          {
            minB: 13.0,                   // was 13.4
            maxB: 13.5,
            maxBInc: true,
          ...
          // ---- Size 15 ----
          {
            ...
            // priority: 0 (default)
            bands: [
              { condition: 'lt', value: 23, prefix: 'ekt' },
              { condition: 'eq', values: [20.5, 21, 21.5], prefix: 'lkt' }, // if you have 'lkt'
              { condition: 'gt', value: 23, prefix: 'okt' }                 // if you have 'okt'
            ],
          },
          // ---- Size 16 ----
          {
