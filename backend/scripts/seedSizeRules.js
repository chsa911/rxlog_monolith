...
const SizeRule = mongoose.model('SizeRule', sizeRuleSchema);
...
async function seed() {
  ...
  const rules = [
    ...
    // ---- Size 2 ----
    {
      ...
      maxBInc: true,
      bands: [
        { condition: 'lt', value: 18, prefix: 'ekb' }
      ]
    },
    // ---- Size 3 ----
    {
    ...
    // ---- Size 4 ----
    {
      ...
      maxBInc: true,
      bands: [
        { condition: 'lt', value: 19, prefix: 'ekg' }
      ]
    },
    // ---- Size 5 ----
    {
    ...
    // ---- Size 6 ----
    {
      ...
      maxBInc: true,
      bands: [
        { condition: 'lt', value: 19, prefix: 'eki' }
      ]
    },
    // ---- Size 7 ----
    {
    ...
    // ---- Size 9 ----
    {
      ...
      maxBInc: true,
      bands: [
        { condition: 'lt', value: 21, prefix: 'ekn' }
      ]
    },
    // ---- Size 10 ----
    {
  ...
  await SizeRule.insertMany(rules);
  console.log(`✅ Inserted ${rules.length} size rules`);
